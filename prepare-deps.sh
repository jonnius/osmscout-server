...
git clone --recursive --shallow-submodules --depth 1 https://github.com/rinigus/pkg-libpostal.git "${LIBPOSTAL_SRC_DIR}"
git clone --recursive --depth 1 https://github.com/rinigus/pkg-mapnik "${MAPNIK_SRC_DIR}"
git clone --recursive --depth 1 https://github.com/rinigus/pkg-valhalla-lite.git "${VALHALLA_SRC_DIR}"
